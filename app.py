...
This code:
- Lets users upload up to 10 JSON files.
- Shows a multi-select box to choose which uploaded files to view.
- Displays all the details of selected files in expandable sections.
- Optionally, users can upsert selected files data into Pinecone with API key and index name inputs.

Run this with `streamlit run app.py` and test uploading your JSON files.

Let me know if you want features like searching or querying Pinecone vectors added!Here is the full Streamlit app code that lets users upload up to 10 JSON files, select which ones to view, display their details clearly, and optionally upsert selected files data to Pinecone:
